...
$orgAdmins = Invoke-RestMethod -Method Get -Uri "https://api.github.com/orgs/$org/members?role=admin" -Headers @{Authorization = "Token $token" } -ContentType "application/json"
